...
```javascript
dnannsum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnannsum@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnannsum@umd/bundle.js"></script>
```
